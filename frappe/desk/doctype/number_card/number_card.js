...
frappe.ui.form.on("Number Card", {
	...
	render_filters_table: function (frm) {
		...
		let table = $(`<table class="table table-bordered" style="cursor:${frm.has_perm("write") ? "pointer" : "default"
			}; margin:0px;">
			<thead>
				<tr>
	...
	render_dynamic_filters_table(frm) {
		...
		frm.dynamic_filter_table = $(`<table class="table table-bordered" style="cursor:${frm.has_perm("write") ? "pointer" : "default"
			}; margin:0px;">
			<thead>
				<tr>
					<th style="width: 20%">${__("Filter")}</th>
